...
function Intro() {
   return (
      <div className='flex flex-col items-center justify-center mb-16'>
         <h1 className='font-Ysabeau italic font-extralight text-7xl text-stone-300 pt-24 pb-6'>
            Ian Fleming
         </h1>
         <h2 className='font-Slabo text-2xl text-stone-300 pb-6'>
            Software Developer & Computer Scientist
         </h2>
         <p className='font-Montserrat w-[500px] text-center border-x-4 border-stone-300 rounded-lg text-md text-stone-300 p-4'>
